...
<div id="wrapper"> 
 ...
 <!--header-starts-->
  ...
  <form id= "f1" method="post" action="includes/add.inc.php" enctype="multipart/form-data">
        <b><label for= "name">Product Name</label></b><br>
        <input type= "text" name="pname" id="pname" required><br>

        <b><label for= "name">Product Price</label></b><br>
        <input type="text" name= "pcost" id="pcost"><br>

        <b><label for= "name">Product Image</label></b><br>
        <input type="file" name="pfile" id= "pfile"><br>

        <b><label for= "name">Product Category</label></b><br>
