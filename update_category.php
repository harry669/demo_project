...
<script>
      ...
      $(document).ready(function()
      {
                    ...
                    let $c_id= $('#c_id').val();
                     ...
                     var $inputs = $form.find("input");
                        // Serialize the data in the form
                            ...
                            request = $.ajax({
                                    url: "http://localhost/E-commerce/includes/update.inc.php",
                                     type: "post",
                                     data: {data: $form_data,id: $c_id,type:"ucat"}
                                     });
        ...
        // Log a message to the console
                                                   ...
                                                   if(response)
                                                   { 
                                                    let url= "http://localhost/E-commerce/nextpage.php";
                                                     window.location.replace(url);
                                                   }
                                                  // let url= "http://localhost/E-commerce/includes/update.inc.php";
                                                   //window.location.replace(url);
                                               });
    ...
    request.always(function () {
        ...
        $inputs.prop("disabled", false);
                ...
                $.post("includes/update.inc.php",formval,function(data,status)
                {
                       //window.location.replace("http://localhost/E-commerce/includes/update.php?id");
                       let url= new URL("http://localhost/E-commerce/includes/update.inc.php?id="+<?php echo $_GET['id']?>);
                       window.location.replace(url);
                })
                */
           })
				...
				<ul>
					<li class="fileds">
                        ...
                        <label> Category Id</label>
                            <input type= "number" id="c_id" value= "<?php echo $_GET['id']?>" disabled>
